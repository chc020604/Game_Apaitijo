...
## 2. 게임 배경 스토리 및 게임 소개 (2분 30초)
신의 검을 만들던 대장장이 신 파이토가 신들의 무시나 제값을 받지 못하는 일들로 인해 몰래 인간에게 검을 판매하다가 인간들이 신에게 대적하는 일이 발생하여 파이토가 검을 인간들에게 판매했다는 사실이 발각됩니다
이에 신들은 파이토가 전설의 검을 만들기 전까지 **신의 대장간**에 가두는 형벌을 내립니다.
파이토는 신과 인간의 갈등 사이속에서 만든 검을 신또는 인간에게 판매하며 재화를 벌고 **전설의 검을 만들어** 엔딩까지 도달하는 게임입니다.
찢어져 볼 수 없는 강화 공식을 찾아가며 강화를 진행해야하며 필요한 재화를 직접 벌어야하는 만큼 전략적인 판매 방법을 찾고 공식과 강화확률을 뚫어내는 것이 핵심인 게임입니다.
...
**가장 혁신적인 부분은** 게임을 새로 시작할 때마다 모든 강화식이 **랜덤으로 변경**된다는 점입니다. 이는 커뮤니티에서 공략을 찾아보거나 공식을 외우는 것을 완전히 무의미하게 만들며, 매번 새로운 탐험과 발견의 재미를 제공합니다.
...
모든 판매 행위는 **전쟁 기여도**에 누적됩니다. 처음에는 중립 상태에서 시작하여, 판매 금액에 비례해 신 또는 인간 쪽으로 기여도가 기울어집니다.
